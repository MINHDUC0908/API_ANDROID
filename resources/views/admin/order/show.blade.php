                ...
                <table class="table info-table mb-0">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="total-price">{{ number_format($order->total_amount) }} ₫</td>
                        </tr>
                        <tr>
                    ...
                    <table class="table items-table mb-0">
                                ...
                                <tr>
                                    <td class="text-center">
                                        @if(isset($item->product->images[0]))
                                            <img src="{{ asset($item->product->images[0]->image_path) }}"
                                                alt="Ảnh sản phẩm"
                                    ...
                                    <td class="text-end price-value">{{ number_format($item->product->price) }} ₫</td>
                                    <td class="text-center">
                                        <span class="fw-bold badge bg-warning">{{ $item->quantity }}</span>
                                    </td>
                                    <td class="text-end total-price">{{ number_format($item->product->price * $item->quantity, 2) }} ₫</td>
                                </tr>
                            @endforeach
                        </tbody>
                        <tfoot class="bg-light">
                                ...
                                <td class="text-end text-danger">
                                    -{{ number_format(
                                        $order->orderItems->sum(function($item) {
                                            return $item->product->price - $item->product->discounted_price;
                                        })
                                    ) }} ₫
                                </td>                       
                            </tr>
                            <tr>
                                ...
                                <td class="text-end total-price">{{ number_format($order->total_amount) }} ₫</td>
                            </tr>
                        </tfoot>                        
                    </table>
                </div>
